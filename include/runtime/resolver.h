...
private:
    ...
    std::pair<std::string, int> resolveVariable(std::string, const std::map<std::string, std::pair<std::string, int>> &);
    void addParam(std::vector<std::pair<std::string, int>> & parsedParam, const std::map<std::string, std::pair<std::string, int>> & globalDataPool, std::string strVal);
